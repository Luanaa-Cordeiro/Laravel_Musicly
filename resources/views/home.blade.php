...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Artistas</h2>
            <p>Card com o número de artistas e botão para ir para a pag artista</p>

            <div class="line"></div>

            <h2>Gêneros</h2>
            <p>Card com o número de generos e botão para ir para a pag generos</p>

            <div class="line"></div>

            <h3>Álbuns</h3>
            <p>Card com o número de Álbuns e botão para ir para a pag Álbuns</p>

            <div class="line"></div>

            <h3>Músicas</h3>
            <p>Card com o número de músicas e botão para ir para a pag músicas</p>
